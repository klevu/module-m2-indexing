...
class UpdateEntitySyncCronObserver implements ObserverInterface
{
    /**
    ...
    public function execute(Observer $observer): void
    {
        ...
        if (
            !in_array(Constants::XML_PATH_ENTITY_CRON_FREQUENCY, $changedPaths, true)
            && !in_array(Constants::XML_PATH_ENTITY_CRON_EXPR, $changedPaths, true)
        ) {
            return;
        }
