 ...
 */
class ClearCacheAfterSuccessfulUpdateAttributeApiCallObserverTest extends TestCase
{
    use AttributesIteratorTrait;
    use ObjectInstantiationTrait;
    use TestImplementsInterfaceTrait;

    private const OBSERVER_NAME = 'Klevu_Indexing_ClearCacheAfterSuccessfulUpdateAttributeApiCall';
    ...
    public function testExecute_ClearsCacheOnlyForProvidedApiKey(): void
    {
        ...
        $eventManager->dispatch(
            eventName: UpdateAction::KLEVU_INDEXING_ATTRIBUTES_ACTION_UPDATE_AFTER,
            data: [
