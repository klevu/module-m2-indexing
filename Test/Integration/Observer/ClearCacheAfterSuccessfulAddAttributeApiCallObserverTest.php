...
use Klevu\Indexing\Service\Action\Sdk\Attribute\AddAction;
...
/**
 * @covers ClearCacheAfterSuccessfulAttributeApiCallObserver::class
 ...
 */
class ClearCacheAfterSuccessfulAddAttributeApiCallObserverTest extends TestCase
{
    use AttributesIteratorTrait;
    use ObjectInstantiationTrait;
    use TestImplementsInterfaceTrait;

    private const OBSERVER_NAME = 'Klevu_Indexing_ClearCacheAfterSuccessfulAddAttributeApiCall';
    private const EVENT_NAME = 'klevu_indexing_attributes_action_add_after';
    ...
    public function testExecute_ClearsCacheOnlyForProvidedApiKey(): void
    {
        ...
        $eventManager->dispatch(
            eventName: AddAction::KLEVU_INDEXING_ATTRIBUTES_ACTION_ADD_AFTER,
            data: [
