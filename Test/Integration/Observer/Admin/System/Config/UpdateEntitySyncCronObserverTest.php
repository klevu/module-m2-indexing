...
use Klevu\Indexing\Observer\Admin\System\Config\UpdateEntitySyncCronObserver;
...
/**
 * @covers UpdateEntitySyncCronObserver
 * @method UpdateEntitySyncCronObserver instantiateTestObject(?array $arguments = null)
 * @method UpdateEntitySyncCronObserver instantiateTestObjectFromInterface(?array $arguments = null)
 * @magentoAppArea adminhtml
 */
class UpdateEntitySyncCronObserverTest extends TestCase
{
    use ObjectInstantiationTrait;
    use StoreTrait;
    use TestImplementsInterfaceTrait;

    private const OBSERVER_NAME = 'Klevu_Indexing_adminSystemConfig_updateEntitySyncCron';
    ...
    protected function setUp(): void
    {
        ...
        $this->implementationFqcn = UpdateEntitySyncCronObserver::class;
    ...
    public function testObserver_IsConfiguredInAdminScope(): void
    {
        ...
        $this->assertSame(
            expected: ltrim(string: UpdateEntitySyncCronObserver::class, characters: '\\'),
        ...
        $observer = $this->objectManager->create(Observer::class, [
            'data' => [
                'changed_paths' => [
                    ...
                    Constants::XML_PATH_ENTITY_CRON_FREQUENCY,
                ],
            ],
        ]);
    ...
    public function testExecute_ExpressionPathChanged(): void
    {
        ...
        $observer = $this->objectManager->create(Observer::class, [
            'data' => [
                'changed_paths' => [
                    Constants::XML_PATH_INDEXING_HISTORY_REMOVAL_AFTER_DAYS,
                    Constants::XML_PATH_ENTITY_CRON_EXPR,
                ],
            ],
        ]);
