...
class AttributeTypeMapperServiceTest extends TestCase
{
    ...
    protected function setUp(): void
    {
        ...
        $this->implementationFqcn = AttributeTypeMapperService::class;
    ...
    /**
     * @TODO change return type to Boolean when it is supported in Klevu Indexing
     */
    ...
    /**
     * @TODO change return type to Datetime when it is supported in Klevu Indexing
     */
     ...
     */
    public function testExecute_ReturnsEnum_ForSelectIntAttribute(): void
    {
        $this->createAttribute([
            'key' => 'klevu_test_select_attribute',
            'code' => 'klevu_test_select_attribute',
