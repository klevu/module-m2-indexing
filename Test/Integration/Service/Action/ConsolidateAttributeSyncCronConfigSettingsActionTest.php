...
use Klevu\Indexing\Service\Action\ConsolidateAttributeSyncCronConfigSettingsAction;
 ...
 */
class ConsolidateAttributeSyncCronConfigSettingsActionTest extends TestCase
{
    ...
    protected function setUp(): void
    {
        ...
        $this->implementationFqcn = ConsolidateAttributeSyncCronConfigSettingsAction::class;
    ...
    public function testExecute_FrequencyNotCustom_ExpressionIsEmpty(
        ...
        ConfigFixture::setGlobal(
            path: Constants::XML_PATH_ATTRIBUTE_CRON_FREQUENCY,
            value: $frequency,
        );
        ConfigFixture::setGlobal(
            path: Constants::XML_PATH_ATTRIBUTE_CRON_EXPR,
            value: '',
        );

        $consolidateConfigAction = $this->instantiateTestObject([
            'configWriter' => $this->getMockConfigWriter([
                Constants::XML_PATH_ATTRIBUTE_CRON_EXPR => $frequency,
            ]),
        ]);
    ...
    public function testExecute_FrequencyIsCustom_ExpressionMatchesFrequency(): void
    {
        ...
        $consolidateConfigAction = $this->instantiateTestObject([
            'configWriter' => $this->getMockConfigWriter([
                Constants::XML_PATH_ATTRIBUTE_CRON_FREQUENCY => CronFrequency::OPTION_DISABLED,
                Constants::XML_PATH_ATTRIBUTE_CRON_EXPR => CronFrequency::OPTION_DISABLED,
            ]),
        ]);
    ...
    public function testExecute_FrequencyIsCustom_ExpressionNotCustom(
        ...
        $consolidateConfigAction = $this->instantiateTestObject([
            'configWriter' => $this->getMockConfigWriter([
                Constants::XML_PATH_ATTRIBUTE_CRON_FREQUENCY => $expression,
            ]),
        ]);
