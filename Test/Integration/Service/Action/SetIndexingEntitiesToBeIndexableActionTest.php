...
use Klevu\Indexing\Service\Action\SetIndexingEntitiesToBeIndexableAction;
...
/**
 * @covers \Klevu\Indexing\Service\Action\SetIndexingEntitiesToBeIndexableAction::class
 * @method SetIndexingEntitiesToBeIndexableActionInterface instantiateTestObject(?array $arguments = null)
 * @method SetIndexingEntitiesToBeIndexableActionInterface instantiateTestObjectFromInterface(?array $arguments = null)
 */
class SetIndexingEntitiesToBeIndexableActionTest extends TestCase
{
    ...
    protected function setUp(): void
    {
        ...
        $this->implementationFqcn = SetIndexingEntitiesToBeIndexableAction::class;
        $this->interfaceFqcn = SetIndexingEntitiesToBeIndexableActionInterface::class;
    ...
    public function testExecute_SetsIndexingEntityToBeIndexable_ForNoneIndexableEntities(string $type): void
    {
        ...
        $this->assertSame(expected: Actions::ADD, actual: $indexingEntity1->getNextAction());
        ...
        $this->assertTrue($indexingEntity3->getIsIndexable());
