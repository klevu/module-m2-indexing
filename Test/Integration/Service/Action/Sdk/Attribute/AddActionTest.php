...
class AddActionTest extends TestCase
{
    ...
    protected function setUp(): void
    {
        ...
        $this->implementationFqcn = AddAction::class;
    ...
    public function testExecute_LogsErrors_WhenAccountServicePutFails(): void
    {
        ...
        $mockLogger->expects($this->once())
            ...
            ->with(
                ...
                [
                    'method' => 'Klevu\Indexing\Service\Action\Sdk\Attribute\AddAction::logFailure',
                    'message' => '401: Attribute klevu_test_attribute failed to register with Klevu: '
    ...
    public function testExecute_WhenAccountServicePutSucceeds(): void
    {
        ...
        $mockEventManager->expects($this->once())
            ->method('dispatch')
            ->with(
                AddAction::KLEVU_INDEXING_ATTRIBUTES_ACTION_ADD_AFTER,
                [
    ...
    public function testExecute_LogsError_WhenBadRequestExceptionThrown(): void
    {
        ...
        $mockLogger->expects($this->once())
            ...
            ->with(
                ...
                [
                    'method' => 'Klevu\Indexing\Service\Action\Sdk\Attribute\AddAction::logFailure',
                    'message' => "400: Attribute klevu_test_attribute failed to register with Klevu: "
