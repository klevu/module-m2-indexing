...
class DeleteActionTest extends TestCase
{
    ...
    protected function setUp(): void
    {
        ...
        $this->implementationFqcn = DeleteAction::class;
    ...
    public function testExecute_LogsErrors_WhenAccountServiceDeleteFails(): void
    {
        /** @var AccountCredentials $accountCredentials */
        $accountCredentials = $this->objectManager->create(AccountCredentials::class, [
            'jsApiKey' => 'klevu-js-api-key',
        ...
        $mockLogger->expects($this->once())
            ...
            ->with(
                ...
                [
                    'method' => 'Klevu\Indexing\Service\Action\Sdk\Attribute\DeleteAction::logFailure',
                    'message' => '401: Attribute klevu_test_attribute failed to delete from Klevu: '
    ...
    public function testExecute_WhenAccountServiceDeleteSucceeds(): void
    {
        /** @var AccountCredentials $accountCredentials */
        $accountCredentials = $this->objectManager->create(AccountCredentials::class, [
            'jsApiKey' => 'klevu-js-api-key',
        ...
        $mockEventManager->expects($this->once())
            ->method('dispatch')
            ->with(
                DeleteAction::KLEVU_INDEXING_ATTRIBUTES_ACTION_DELETE_AFTER,
                [
    ...
    public function testExecute_LogsError_WhenBadRequestExceptionThrown(): void
    {
        ...
        $mockLogger->expects($this->once())
            ...
            ->with(
                ...
                [
                    'method' => 'Klevu\Indexing\Service\Action\Sdk\Attribute\DeleteAction::logFailure',
                    'message' => "400: Attribute klevu_test_attribute failed to delete from Klevu: "
