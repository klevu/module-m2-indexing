...
class SetIndexingAttributesToDeleteAction implements SetIndexingAttributesToDeleteActionInterface
{
    /**
    ...
    public function execute(array $attributeIds): void
    {
        ...
        foreach ($indexingAttributes as $indexingAttribute) {
            try {
                $indexingAttribute->setNextAction(nextAction: Actions::DELETE);
                ...
                $this->logger->error(
                    ...
                    context: [
                        'method' => __METHOD__,
                        'entity_id' => $indexingAttribute->getId(),
