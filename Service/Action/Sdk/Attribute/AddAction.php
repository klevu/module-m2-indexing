...
{
    public const KLEVU_INDEXING_ATTRIBUTES_ACTION_ADD_AFTER = 'klevu_indexing_attributes_action_add_after';
    ...
    public function execute(
        ...
        $response = $this->createAttributeViaSdk(
            accountCredentials: $accountCredentials,
            attribute: $attribute,
        );
        $this->handleResponse(
     ...
     */
    private function createAttributeViaSdk(
        AccountCredentials $accountCredentials,
        SdkAttributeInterface $attribute,
    ): SyncResultInterface {
        try {
    ...
    private function dispatchEvent(
        ...
        $this->eventManager->dispatch(
            static::KLEVU_INDEXING_ATTRIBUTES_ACTION_ADD_AFTER,
            [
    ...
    private function logFailure(
        ...
        $this->logger->error(
            ...
            context: [
                'method' => __METHOD__,
                'message' => sprintf(
                    '%s: Attribute %s failed to register with Klevu: %s',
                    $response->getCode(),
