...
class SetIndexingAttributesToBeIndexableAction implements SetIndexingAttributesToBeIndexableActionInterface
{
    /**
    ...
    public function execute(array $attributeIds): void
    {
        ...
        foreach ($indexingAttributes as $indexingAttribute) {
            ...
            try {
                $indexingAttribute->setNextAction(nextAction: Actions::ADD);
                $indexingAttribute->setIsIndexable(isIndexable: true);
